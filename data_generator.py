...
if __name__ == "__main__":
    ...
    # 2. Create a larger population (15,000 users)
    gen.create_users(15000) 
    
    # 3. Inject Random Noise (70,000 normal transactions)
    gen.inject_random_noise(70000) 
    
    # 4. Inject multiple Fraud Rings (50 rings = 500 fraud transactions)
    for i in range(50):
